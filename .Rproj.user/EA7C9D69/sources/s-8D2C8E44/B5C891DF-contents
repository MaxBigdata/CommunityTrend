...
trend <- function(community_name_x) {
  ...
  print('-------------------------------------')
  print('过去一个月内自如：')
  print(paste0("|所在商圈:",the_attributes$business_district))

  print(paste0("|社区合租单间销量：",the_attributes$community_other_num))
  print(paste0("|社区合租单间均价：",the_attributes$community_average_price))
  print(paste0("|社区合租单间平均面积：",the_attributes$community_average_area))
  ...
  print(paste0("|当地商圈合租单间平均面积：",the_attributes$business_district_average_area))
