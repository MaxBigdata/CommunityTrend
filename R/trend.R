...
trend <- function(community_name_x) {
  ...
  print(paste0("|社区总房数：",the_attributes3$all_num_community))
  ...
  print('|')
  print(paste0("|社区月内新上架单间成交量:",the_attributes3$community_sales_num))
  print(paste0("|社区月内新上架单间平均展示期:",the_attributes3$exbination_and_adjustment_ave_exhibition_period))
  print(paste0("|社区月内新上架单间平均调价数:",the_attributes3$price_adjustment_num))
  print(paste0("|社区月内新上架单间平均调价价格:",the_attributes3$price_adjustment_average))
